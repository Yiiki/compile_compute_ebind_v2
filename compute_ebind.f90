...
call read_rho(fref,rho,AL,n1,n2,n3,nnodest)
V_bulk=rho(n1_ref, n2_ref, n3_ref )*E_AU
...
if(ist) then
call read_rho(ftmp,rho,AL,n1,n2,n3,nnodest)
V_corner=rho(n1_tmp, n2_tmp, n3_tmp)*E_AU
else
